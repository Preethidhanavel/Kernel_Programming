...
#define TIMEOUT 5000  // Timer interval in milliseconds

static struct timer_list dev_timer;  // Kernel timer structure
static unsigned int count = 0;       // Timer callback counter
